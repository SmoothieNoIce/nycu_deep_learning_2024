...
if __name__ == '__main__':
    ...
    generator.load_state_dict(torch.load(os.path.join(args.resume, 'netG_epoch_7.pth')))
    discriminator.load_state_dict(torch.load(os.path.join(args.resume, 'netD_epoch_7.pth')))
